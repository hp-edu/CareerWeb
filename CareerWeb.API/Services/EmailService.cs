...
namespace CareerWeb.API.Services
{
    public class EmailService
    {
        private const string smtpHost = "email-smtp.ap-northeast-2.amazonaws.com";
        private const string smtpUserName = "AKIA2UC3ECBWLURUIAKS";
        private const string smtpPassword = "BCBkitZu7bJgjBnggrBaaifodR+YHXD3z10LrBczIGKY";
        private const string fromEmail = "hyukpyohong@gmail.com";
        private const string toEmail = "hyukpyohong@gmail.com";
